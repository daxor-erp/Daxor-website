        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-white/60 max-w-xs">
              The modernization partner for teams migrating to Microsoft Fabric — securely, at scale.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/" hash="solutions" className="hover:text-white">Fabric Foundations</Link></li>
              <li><Link to="/" hash="solutions" className="hover:text-white">Fabric Jumpstart</Link></li>
              <li><Link to="/" hash="solutions" className="hover:text-white">Platform Operations</Link></li>
              <li><Link to="/" hash="solutions" className="hover:text-white">AI Enablement</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/" hash="customers" className="hover:text-white">Customers</Link></li>
              <li><Link to="/pricing" className="hover:text-white">Pricing</Link></li>
              <li><Link to="/" hash="platform" className="hover:text-white">Platform</Link></li>
              <li><Link to="/" hash="contact" className="hover:text-white">Contact</Link></li>
            </ul>
          </div>
